...
img = cv2.imread('Resources\Pic2_3.bmp')  # 读取图片
...
fresult = open(r'C:\Users\86433\Desktop\2_3.txt', 'w')
...
image_resize = cv2.resize(img,(640,480))

cv2.imshow('Pic_2.3 detected circles',image_resize )  # 第一参数为窗口名称
cv2.imwrite('result/Pic_2.3 detected circles.png',img)
